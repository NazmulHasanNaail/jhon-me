 ...
 */
function jhon_me_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'jhon-me' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'jhon-me' ),
...
add_action( 'widgets_init', 'jhon_me_widgets_init' );
