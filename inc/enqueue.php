...
function jhon_me_scripts() {
    ...
    wp_enqueue_script( 'numscroller-js', get_template_directory_uri() . '/assets/js/numscroller-1.0.js', array('jquery'), _S_VERSION, true );
    ...
    wp_enqueue_script( 'smooth-scroll-js', get_template_directory_uri() . '/assets/js/smooth-scroll.polyfills.min.js', array('jquery'), _S_VERSION, true );
